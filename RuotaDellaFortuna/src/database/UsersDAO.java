...
public interface UsersDAO {
	 ...
	 * @return <code>true</code> se l'inserimento e' andato a buon fine, altrimenti
	 *         <code>false</code>
	...
	/**
	 * Questo metodo permette di ottenere le informazioni di un utente conoscendo la
	 * sua email
	 * 
	...
	/**
	 * Questo metodo permette di ottenere le informazioni di un utente conoscendo il
	 * suo nickname
	 * 
	 ...
	 * @return <code>true</code> se la modifica e' andata a buon fine, altrimenti
	 *         <code>false</code>
	 * @throws SQLException in caso di errore di connessione al database
	 */
	...
	/**
	 * Permette di individuare l'utente che ha ottenuto il punteggio piu' alto alla
	 * fine di una manche
	 *
	 * @return un oggetto di tipo UsersDTO
	 * @throws SQLException in caso di errore di connessione al database
	 */
	...
	/**
	 * Permette di individuare l'utente con la media di punti acquisiti per manche
	 * piu' alta
	 *
	 * @return un oggetto di tipo UsersDTO
	 * @throws SQLException in caso di errore di connessione al database
	...
	/**
	 * Permette di individuare l'utente che ha ceduto di piu' il turno in seguito ad
	 * errori
	 *
	 * @return un oggetto di tipo UsersDTO
	 * @throws SQLException in caso di errore di connessione al database
	...
	/**
	 * Permette di individuare l'utente che ha perso tutto dal giro di ruota piu'
	 * volte
	 *
	 * @return un oggetto di tipo UsersDTO
	 * @throws SQLException in caso di errore di connessione al database
