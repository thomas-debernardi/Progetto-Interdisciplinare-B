...
public interface MancheJoinersDAO {
	...
	/**
	 * Metodo che permette l'aggiunta di un utente che si è unito a una partita al
	 * db
	 * 
	 * @param idMatch   identificativo del match
	 * @param numManche numero manche
	 * @param idPlayer  identificativo del giocatore
	 * @param observer  <code>true</code> se era un osservatore, altrimenti
	 *                  <code>false</code>
	...
	/**
	 * Metodo che permette di viualizzare il numero delle manche giocate da un
	 * utente
	 * 
	...
	/**
	 * Metodo che permette la visualizzazione del numero di match giocati da un
	 * utente
	 * 
	 * @param id identificativo utente
	...
	/**
	 * Metodo che permette la visualizzazione del numero di manche osservate da un
	 * utente
	 * 
	 * @param id identificativo utente
	...
	/**
	 * Metodo che permette la visualizzazione del numero di match osservati da un
	 * utente
	 * 
	 * @param id identificativo utente
