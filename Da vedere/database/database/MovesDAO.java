...
public interface MovesDAO {
     ...
     * @return <code>true</code> se avviene il corretto inserimento, altrimenti <code>false</code>
    ...
    /**
     * Metodo che permette di visualizzare la mossa che ha portato ad avere un punteggio più alto
    ...
    /**
     * Metodo che permette di visualizzare il numero medio di mosse, per indovinare una frase, che vengono eseguite per manche 
    ...
    /**
     * Metodo che permette di visualizzare il numero di tutti i turni passati da un giocatore
    ...
    /**
     * Metodo che permette di visualizzare il numero di tutte le volte che un utente ha perso un turno
     * @param id identificativo del giocatore
