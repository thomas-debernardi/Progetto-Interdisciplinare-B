...
/**
 * Interfaccia utilizzata dai manager del server per accedere ai metodi del database
 */
public interface DBManagerInterface {
	 ...
	 * @return <code>true</code> se l'inserimento partita va a buon fine, altrimenti <code>false</code>
	 */
	 ...
	 * @param isAdmin <code>true</code> se l'utente è un admin, altrimenti <code>false</code>
	 * @return <code>true</code> se l'inserimento utente va a buon fine, altrimenti <code>false</code>
	 */
	 ...
	 * 
	 * @param id identificativo dell'utente
	 * @return <code>true</code> se l'utente è stato eliminato, altrimenti <code>false</code>
	 */
	boolean deleteUser(String id);

	/**
	 * Metodo che permette di controllare la correttezza della mail e password, inoltre determina se l'utente è un admin
	 * 
	 ...
	 * @return <code>-1</code> se la password o la mail (o entrambe) sono errate, <code>0</code> se l'utente è un admin, <code>1</code> se l'utente non lo è
	 */
	int checkLogin(String email, String password, boolean admin);

	/**
	 * Metodo che prende dal database cinque frasi che i giocatori non hanno mai visto
	 *  
	 ...
	 * @return <code>true</code> se il match è stato eliminato, altrimenti <code>false</code>
	 */
	 ...
	 * @return <code>true</code> se la mossa è stata inserita, altrimenti <code>false</code>
	 */
	...
	/**
	 * Metodo che permette di collegare gli utenti che hanno osservato o giocato una determinata manche 
	 * 
	 * @param idMatch identificativo del match
	 * @param numManche numero della manche
	 * @param userId identificativo dell'utente
	 * @param observer <code>true</code> se è un osservatore, se non lo è <code>false</code>
	 * @return <code>true</code> se l'inserimento è andato a buon fine, altrimenti <code>false</code>
	 */
	 ...
	 * @return <code>true</code> se la modifica viene eseguita, altrimenti <code>false</code>
	 */
	boolean updateUser(UsersDTO user);

	/**
	 * Metodo che permette di visualizzare la miglior mossa eseguita (quella che ha fatto guadagnare più punti
	 * 
	...
	/**
	 * Metodo che permette di visualizzare, per manche, il numero medio di mosse per indovinare la frase
	 * 
	...
	/**
	 * Metodo che permette di visualizzare il numero medio di punti fatti da un utente per partita
	 * 
	 * @param id identificativo del giocatore
	...
	/**
	 * Metodo che permette di visualizzare il numero medio di turni passati da parte di un utente per manche
	 * 
	 * @param id identificativo del giocatore
	...
	/**
	 *  Metodo che permette di visualizzare il numero medio di turni passati da parte di un utente per match
	 *  
	 * @param id identificativo del giocatore
	...
	/**
	 * Metodo che permette di visualizzare il numero medio di volte che un utente ha perso tutto per manche
	 * 
	 * @param id identificativo del giocatore
	...
	/**
	 * Metodo che permette di visualizzare il numero medio di volte che un utente ha perso tutto per match
	 * 
	 * @param id identificativo del giocatore
	...
	/**
	 * Metodo per visualizzare il giocatore con la media di punti più alta acquisiti per manche 
	 * 
	 * @return oggetto della classe UsersDTO che si riferisce al giocatore
	 */
	...
	/**
	 * Metodo per visualizzare il giocatore che ha perso più turni in seguito a errori
	 * 
	 * @return oggetto della classe UsersDTO che si riferisce al giocatore
	 */
