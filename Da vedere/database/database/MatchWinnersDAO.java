...
public interface MatchWinnersDAO {
	 ...
	 * @return <code>true</code> se si verifica il corretto inserimento, altrimenti <code>false</code> 
	...
	/**
	 * Metodo che restituisce il totale dei punti in tutti i match vinti da un utente
	 * 
