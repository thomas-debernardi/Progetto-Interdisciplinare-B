...
public class RegistrationManager {
	...
	/**
     * Questo metodo permette la registrazione di un nuovo account da parte del client
     *
     * @param form  un oggetto di tipo User contenente tutti i dati necessari
     * @param c     il riferimento al client
     * @param admin <code>true</code> se si registra un admin, <code>false</code> altrimenti
	 ...
	 * @return <code>true</code> se il nickname è unica, altromenti <code>false</code>
	 */
	 ...
	 * @return <code>true</code> se la password è nuova, altrimenti <code>false</code>
	 */
